...
\section{From Structural Realism to Structural Idealism}
...
Idealism, in the present context, should not be confused as identical with some fundamental subjectivism or skepticism about the external world.

Certain strains of idealism identify substance as being a more sophisticated form of universal \emph{Mind}.  I am not an expert, but it is obvious enough on a first pass that many positions are perfectly fine with there being a substance, and unifying the nature of that substance with the apparent subjective nature of the mind in e.g. a physicist's mind.  Whether this is tenable and coherent is beyond the current proposal, but there are attempts (e.g. [CITE HEGEL]).
...
\subsection{Prospective and Supplementary}
...
\subsection{OSR vs. ESR}

Two strains that seem to be obvious


\section{Structural Idealism: Quotes}
...
\section{Smuggling in Quantum Mysticism}
